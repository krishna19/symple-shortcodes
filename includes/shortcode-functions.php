		...
		if ( $button_text !== '' ) {
			$output .= '<div class="symple-callout-button">';
				...
				if ( $icon_left !== '' && $icon_left !== 'none' ) {
					$output .= '<i class="symple-callout-icon-left fa fa-'. $icon_left .'"></i>';
				}
				$output .= $button_text;
				if ( $icon_right !== '' && $icon_right !== 'none' ) {
					$output .= '<i class="symple-callout-icon-right fa fa-'. $icon_right .'"></i>';
				}
			$output .='</span></a>';
			$output .='</div>';
		}
	...
	function symple_pricing_shortcode( $atts, $content = null  ) {
		...
		$pricing_content .= '<div class="symple-pricing symple-'. $size .' '. $featured_pricing .' symple-column-'. $position. ' '. $class .'">';
			...
			if( $button_url ) {
				...
				if ( $icon_left !== '' && $icon_left !== 'none' ) {
					$pricing_content .= '<i class="symple-pricing-button-icon-left fa fa-'. $icon_left .'"></i>';
				}
				$pricing_content .= $button_text;
				if ( $icon_right !== '' && $icon_right !== 'none' ) {
					$pricing_content .= '<i class="symple-pricing-button-icon-right fa fa-'. $icon_right .'"></i>';
				}
